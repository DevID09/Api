...
for i in range(1000000):
    ...
    try:
        ualist.append(f'[FBAN/FBIOS;FBAV/{fb};FBBV/{code};FBRV/0;FBDV/iPhone7,{iphone};FBMD/iPhone;FBSN/iPhone OS;FBSV/{ios};FBSS/2;FBCR/nTelos;FBID/Phone;FBLC/en_GB;FBOP/5]')
    except IndexError:
        pass
def _404_():
    logo()
